...
Gauge = (function(superClass) {
  ...
  Gauge.prototype.renderGuide = function() {
    var arc, arc_params, d, end_angle, radius, ref, start_angle, thickness;
    ref = this, radius = ref.radius, thickness = ref.thickness, start_angle = ref.start_angle, end_angle = ref.end_angle;
