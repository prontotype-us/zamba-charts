...
Gauge = React.createClass({displayName: "Gauge",
  ...
  render: function() {
    var a_color, arc, bar, d, di, end_angle, guide, height, label_d_y, markers, max, min, options, radius, ref, ref1, ref2, renderMarker, show_value, start_angle, thickness, title, value, value_color, value_data, value_range, width;
    ...
    min = options.min, max = options.max, start_angle = options.start_angle, end_angle = options.end_angle, show_value = options.show_value, guide = options.guide, bar = options.bar;
    this.min || (this.min = 0);
