...
module.exports = Histogram = React.createClass({displayName: "Histogram",
  ...
  render: function() {
    var axis_size, bin, bins, color, data, data_by_group, datas, group, group_value, height, i, len, n_bins, onClick, padding, ref, ref1, ref2, title, total, width, x, x_axis, x_extent, y, y_axis, y_max;
    ref = this.props, width = ref.width, height = ref.height, padding = ref.padding, data = ref.data, x = ref.x, y = ref.y, axis_size = ref.axis_size, title = ref.title, x_axis = ref.x_axis, y_axis = ref.y_axis, color = ref.color, onClick = ref.onClick;
