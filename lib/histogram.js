...
module.exports = Histogram = React.createClass({
  ...
  render: function() {
    var axis_size, bin, bins, color, data, data_by_group, datas, group, group_value, height, n_bins, onClick, padding, title, total, width, x, x_axis, x_extent, y, y_axis, y_max, _i, _len, _ref, _ref1, _ref2;
    _ref = this.props, width = _ref.width, height = _ref.height, padding = _ref.padding, data = _ref.data, x = _ref.x, y = _ref.y, axis_size = _ref.axis_size, title = _ref.title, x_axis = _ref.x_axis, y_axis = _ref.y_axis, color = _ref.color, onClick = _ref.onClick;
