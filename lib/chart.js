...
module.exports = Chart = React.createClass({displayName: "Chart",
  ...
  render: function() {
    var adjust, axis_size, chart_height, chart_options, chart_width, children, color, colorer, data, datas, height, options, padding, ref1, ref2, ref3, ref4, ref5, show_follower, title, width;
    ...
    return React.createElement("div", {
      ...
      return function(data, di) {
        return React.createElement("g", {
          "transform": "translate(" + axis_size + ",0)"
