...
module.exports = Chart = React.createClass({displayName: "Chart",
  ...
  render: function() {
    var adjust, axis_size, children, color, data, datas, height, options, padding, ref1, ref2, ref3, ref4, ref5, show_follower, title, width;
    ...
    }) : void 0), React.createElement(YAxis, {
      "y": this.state.y,
      "width": axis_size,
      "height": height,
      "padding": padding,
      "options": options != null ? (ref5 = options.axes) != null ? ref5.y : void 0 : void 0
