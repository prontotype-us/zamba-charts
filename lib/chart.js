...
module.exports = Chart = React.createClass({displayName: "Chart",
  ...
  render: function() {
    var adjust, axis_size, chart_options, children, color, colorer, data, datas, height, options, padding, ref1, ref2, ref3, ref4, ref5, show_follower, title, width;
    ...
    console.log('my options', chart_options);
