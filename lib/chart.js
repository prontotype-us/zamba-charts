...
module.exports = Chart = React.createClass({displayName: "Chart",
  ...
  createAxes: function(props) {
    var adjust, axis_size, chart_height, chart_width, data, datas, height, options, ref1, ref2, width, x, x_extent, y, y_extent;
    ...
    if (options != null ? (ref1 = options.axes) != null ? (ref2 = ref1.y) != null ? ref2.zero : void 0 : void 0 : void 0) {
      y_extent = [
