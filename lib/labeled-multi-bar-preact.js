...
module.exports = LabeledMultiBarChart = (function(superClass) {
  ...
  LabeledMultiBarChart.prototype.renderChart = function() {
    var all_ys, bar_padding, bar_width, cell_index, cell_width, chart_height, colorer, colors, data, el_padding, height, horizontal, markers, num_bars, options, ref, segment_width, spread, total_ys, width, x, x_extent, y, y_extent, y_max;
