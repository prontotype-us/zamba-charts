...
module.exports = LabeledMultiBarChart = (function(superClass) {
  ...
  LabeledMultiBarChart.prototype.render = function() {
    var all_ys, bar_padding, bar_width, cell_index, cell_width, chart_height, colorer, colors, data, height, horizontal, num_bars, options, ref, spread, total_ys, width, x, x_extent, y, y_extent, y_max;
