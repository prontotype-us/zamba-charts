    ...
    if (!spread) {
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          var l, label_height, label_width, label_x, label_x_tmp, label_y, label_y_tmp, total_y;
          cell_index++;
          total_y = 0;
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_width = 6.5 * l.length, label_height = 8, label_x = cell_width * (i_data + 0.5) - label_width / 2, label_y = height + el_padding + 15, rotate_labels > 0 ? label_x = cell_width * (i_data + 0.5) - label_height / 2 : void 0, horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
            "width": cell_width,
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          var cell_markers, family_width, l, label_height, label_width, label_x, label_x_tmp, label_y, label_y_tmp, total_y;
          total_y = 0;
          cell_index++;
          ...
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_width = 6 * l.length, label_height = 8, label_x = family_width * (i_data + 0.5) - label_width / 2 - cell_width / 2, label_y = height + el_padding + 15, rotate_labels > 0 ? label_x = family_width * (i_data + 0.5) - label_height / 2 - cell_width / 2 : void 0, horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
            "width": cell_width,
