...
module.exports = LabeledMultiBarChart = (function(_super) {
  ...
  LabeledMultiBarChart.prototype.renderChart = function() {
    var all_ys, bar_padding, bar_width, cell_index, cell_width, chart_height, colorer, colors, data, el_padding, height, horizontal, markers, num_bars, options, rotate_labels, segment_width, spread, total_ys, width, x, x_extent, y, y_extent, y_max, _ref, _ref1, _ref2;
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          ...
          return React.createElement("g", {
            ...
            var left_padding, offset_left, offset_top, renderBar, segment_color, segment_height, tmp, value, x_pos, y_pos, _ref3, _ref4;
            value = d.values[segment_key];
            total_y = total_y + value;
            segment_color = (typeof colorer === "function" ? colorer(segment_key) : void 0) || d.color || (colors != null ? colors[segment_key] : void 0) || "#333";
            segment_height = y(value);
