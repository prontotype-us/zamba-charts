...
module.exports = LabeledMultiBarChart = (function(superClass) {
  ...
  LabeledMultiBarChart.prototype.chartHeight = function() {
    var height, label_height, max_label_length, ref, ref1, ref2, rotate;
    if (rotate = (ref = this.props.x_axis) != null ? ref.rotate : void 0) {
      max_label_length = 0;
    ...
    height = this.props.height + (((ref1 = this.props) != null ? (ref2 = ref1.options) != null ? ref2.el_padding : void 0 : void 0) || 0) + 15 + label_height;
    return height;
  };

  LabeledMultiBarChart.prototype.renderChart = function() {
    var all_ys, bar_padding, bar_width, cell_index, cell_width, chart_height, colorer, colors, data, el_padding, height, horizontal, markers, num_bars, options, ref, ref1, ref2, rotate_labels, segment_width, spread, total_ys, width, x, x_extent, y, y_extent, y_max;
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          ...
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_height = 8, label_x = cell_width * (i_data + 0.5), label_y = height + 15 + el_padding, rotate_labels > 0 ? (text_anchor = 'start', label_x -= label_height / 2) : rotate_labels < 0 ? (text_anchor = 'end', label_x += label_height / 2) : text_anchor = 'middle', horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
            ...
            var left_padding, offset_left, offset_top, ref3, ref4, renderBar, segment_color, segment_height, segment_width, tmp, value, x_pos, y_pos;
            ...
            if ((options.display_values != null) && value > 0) {
              ...
              return React.createElement("g", {
                ...
                "x": label_x,
                "y": y_pos + offset_top
              }, (((ref3 = options.display_values) != null ? ref3.display : void 0) ? (ref4 = options.display_values) != null ? ref4.display(value) : void 0 : value)));
            } else {
              return renderBar();
            }
          }));
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          ...
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_height = 8, label_x = family_width * (i_data + 0.5) - cell_width / 2, label_y = height + 15 + el_padding, rotate_labels > 0 ? (text_anchor = 'start', label_x -= label_height / 2) : rotate_labels < 0 ? (text_anchor = 'end', label_x += label_height / 2) : text_anchor = 'middle', horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
            "text-anchor": text_anchor,
            ...
            var left_padding, offset_left, offset_top, ref3, ref4, renderBar, segment_color, segment_height, tmp, value, x_pos, y_pos;
            value = d.values[segment_key];
            total_y = total_y + value;
            segment_color = (typeof colorer === "function" ? colorer(segment_key) : void 0) || d.color || (colors != null ? colors[segment_key] : void 0) || "#333";
            segment_height = y(value);
