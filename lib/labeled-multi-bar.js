    ...
    if (!spread) {
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          var l, label_height, label_width, label_x, label_x_tmp, label_y, label_y_tmp, text_anchor, total_y;
          cell_index++;
          total_y = 0;
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_width = 6.5 * l.length, label_height = 8, label_x = cell_width * (i_data + 0.5), label_y = height + el_padding + 15, rotate_labels > 0 ? (text_anchor = 'start', label_x -= label_height / 2) : rotate_labels < 0 ? (text_anchor = 'end', label_x += label_height / 2) : text_anchor = 'middle', horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          var cell_markers, family_width, l, label_height, label_width, label_x, label_x_tmp, label_y, label_y_tmp, text_anchor, total_y;
          total_y = 0;
          cell_index++;
          ...
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (l = d.label, label_width = 6 * l.length, label_height = 8, label_x = family_width * (i_data + 0.5) - cell_width / 2, label_y = height + el_padding + 15, rotate_labels > 0 ? (text_anchor = 'start', label_x -= label_height / 2) : rotate_labels < 0 ? (text_anchor = 'end', label_x += label_height / 2) : text_anchor = 'middle', horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
            "className": 'label',
            "y": label_y,
            "x": label_x,
            "text-anchor": text_anchor,
            ...
            var left_padding, segment_color, segment_height, tmp, value, x_pos, y_pos;
            value = d.values[segment_key];
            total_y = total_y + value;
            segment_color = (typeof colorer === "function" ? colorer(segment_key) : void 0) || d.color || (colors != null ? colors[segment_key] : void 0) || "#333";
            segment_height = y(value);
