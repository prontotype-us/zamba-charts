...
module.exports = LabeledMultiBarChart = (function(superClass) {
  ...
  LabeledMultiBarChart.prototype.renderChart = function() {
    var all_ys, bar_padding, bar_width, cell_index, cell_width, chart_height, colorer, colors, data, el_padding, height, horizontal, markers, num_bars, options, ref, ref1, segment_width, spread, total_ys, width, x, x_extent, y, y_extent, y_max;
    ...
    if (!spread) {
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          ...
          return React.createElement("g", {
            "className": 'bar',
            "key": i_data
          }, (ref2 = d.label) != null ? ref2.split(' ').map(function(l, i_label) {
      ...
      return React.createElement("svg", {
        ...
        return function(d, i_data) {
          var cell_markers, family_width, ref2, total_y;
          total_y = 0;
          cell_index++;
