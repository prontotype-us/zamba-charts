...
exports.YAxis = function(arg) {
  var border, format, height, label, padding, position, style, ticks, width, y;
  width = arg.width, height = arg.height, y = arg.y, padding = arg.padding, position = arg.position, format = arg.format, ticks = arg.ticks, label = arg.label, border = arg.border;
  padding || (padding = 0);
  style = {
    width: width,
    height: height,
