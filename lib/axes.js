...
exports.XAxis = React.createClass({displayName: "XAxis",
  render: function() {
    var axis_size, format, formatter, height, label_values, options, padding, position, ref, style, width, x;
    ...
    return React.createElement("svg", {
      ...
      "style": style
    }, ((label_values = options != null ? options.label_values : void 0) ? Object.keys(label_values).map(function(l_k) {
