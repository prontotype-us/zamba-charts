...
exports.XAxis = function(_arg) {
  ...
  width = _arg.width, height = _arg.height, x = _arg.x, position = _arg.position, format = _arg.format, ticks = _arg.ticks, labels = _arg.labels, label = _arg.label;
  style = {
    width: width,
    height: height,
    position: 'absolute',
...
exports.YAxis = function(_arg) {
  ...
  width = _arg.width, height = _arg.height, y = _arg.y, position = _arg.position, format = _arg.format, ticks = _arg.ticks, label = _arg.label;
  style = {
    width: width,
    height: height,
    position: 'absolute',
