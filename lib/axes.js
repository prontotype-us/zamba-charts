...
exports.XAxis = function(arg) {
  var format, height, label, labels, position, style, ticks, width, x;
  width = arg.width, height = arg.height, x = arg.x, position = arg.position, format = arg.format, ticks = arg.ticks, labels = arg.labels, label = arg.label;
  style = {
    width: width,
    height: height,
    position: 'absolute',
...
exports.YAxis = function(arg) {
  var format, height, label, position, style, ticks, width, y;
  width = arg.width, height = arg.height, y = arg.y, position = arg.position, format = arg.format, ticks = arg.ticks, label = arg.label;
  style = {
    width: width,
    height: height,
    position: 'absolute',
