...
module.exports = LabeledBarChart = (function(superClass) {
  ...
  LabeledBarChart.prototype.renderChart = function() {
    var axis_size, bar_padding, bar_width, cell_width, data, height, num_bars, options, ref, width, x, x_extent, y;
    ...
    if (options != null) {
      bar_padding = options.bar_padding, bar_width = options.bar_width;
    }
