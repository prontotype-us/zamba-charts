...
module.exports = LabeledBarChart = (function(superClass) {
  ...
  LabeledBarChart.prototype.chartHeight = function() {
    ...
    }), label_height = max_label_length * 6 * Math.sin(Math.PI * rotate / 180)) : label_height = 8;
  ...
  LabeledBarChart.prototype.renderChart = function() {
    ...
    return React.createElement("svg", {
      ...
      return function(d, di) {
        var l, label_height, label_width, label_x, label_x_tmp, label_y, label_y_tmp;
        return React.createElement("g", {
          "className": 'bar'
        }, (l = d.label, label_width = 6.5 * l.length, label_height = 8, label_x = cell_width * (di + 0.5) - label_width / 2, label_y = height + bar_padding + 15, rotate_labels > 0 ? label_x = cell_width * (di + 0.5) - label_height / 2 : void 0, horizontal ? (label_y_tmp = label_y, label_x_tmp = label_x, label_x = label_y, label_y = label_x_tmp) : void 0, React.createElement("text", {
          "className": 'label',
          "y": label_y,
          "x": label_x,
          "width": cell_width,
