...
module.exports = LabeledBarChart = (function(superClass) {
  ...
  LabeledBarChart.prototype.renderChart = function() {
    var axis_size, bar_padding, bar_width, cell_width, chart_height, data, height, horizontal, num_bars, options, ref, ref1, width, x, x_extent, y;
    ...
    console.log('my domain', y.domain());
    if (options != null) {
