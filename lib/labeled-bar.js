...
module.exports = LabeledBarChart = React.createClass({displayName: "LabeledBarChart",
  ...
  render: function() {
    var axis_size, bar_padding, bar_width, data, height, num_bars, ref, width, x, x_extent, y;
    ref = this.props, width = ref.width, height = ref.height, data = ref.data, x = ref.x, y = ref.y, bar_padding = ref.bar_padding, axis_size = ref.axis_size;
