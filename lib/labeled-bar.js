...
module.exports = LabeledBarChart = (function(_super) {
  __extends(LabeledBarChart, _super);
  ...
  LabeledBarChart.prototype.chartHeight = function() {
    var height, label_height, max_label_length, rotate, _ref;
    max_label_length = (rotate = (_ref = this.props.x_axis) != null ? _ref.rotate : void 0) ? (max_label_length = 0, this.props.data.forEach(function(d) {
      var _ref1;
  ...
  LabeledBarChart.prototype.renderChart = function() {
    var axis_size, bar_padding, bar_width, cell_width, chart_height, data, height, horizontal, num_bars, options, rotate_labels, width, x, x_extent, y, _ref, _ref1, _ref2;
    _ref = this.props, width = _ref.width, height = _ref.height, data = _ref.data, x = _ref.x, y = _ref.y, options = _ref.options, axis_size = _ref.axis_size;
