...
module.exports = StackedBarChart = React.createClass({displayName: "StackedBarChart",
  mixins: [Chart],
  multi: true,
  renderChart: function() {
    var bar_gap, bar_width, color, data, height, onClick, padding, ref, width, x, x_extent, y;
    ref = this.props, width = ref.width, height = ref.height, padding = ref.padding, data = ref.data, x = ref.x, y = ref.y, bar_width = ref.bar_width, color = ref.color, onClick = ref.onClick;
